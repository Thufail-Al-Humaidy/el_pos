                      ...
                      <?php else : ?>
                        <table class="table table-striped">
                          ...
                          <?php foreach ($sales as $category) : ?>
                            <tr>
                              <td><?= $i ?></td>
                              <td><?= htmlspecialchars($category['name_customer']) ?></td>
                              <td><?= htmlspecialchars($category['note']) ?></td>
                              <td><?= htmlspecialchars($category['amount']) ?></td>
                              <td><?= htmlspecialchars($category['full_name']) ?></td>
                              <td>
                                <button onclick="modaldetail(<?= $category['id_sale'] ?>, '<?= htmlspecialchars($category['name_customer']) ?>')" class="btn btn-primary"><i class="fas fa-eye"></i></button>
                                <a href="../services/delete-category.php?id=<?= $category['id_sale'] ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                <a href="edit-category.php?id=<?= $category['id_sale'] ?>" class="btn btn-success"><i class="fas fa-edit"></i></a>
                              </td>
                            </tr>
                            <?php $i++; ?>
                          <?php endforeach; ?>
